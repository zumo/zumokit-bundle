 ...
 *
 * This class represents the request that queries the ZumoKit API about the
 * user that just logged in to the app. The query payload is passed via request
 * headers. The following headers are required:
 *
...
class AccountCheckRequest extends SapiRequest
{
    ...
    {
        return 'https://k.it/sapi/accounts/check';
    }
